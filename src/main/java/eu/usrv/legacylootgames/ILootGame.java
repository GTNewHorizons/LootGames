...
public interface ILootGame {
    ...
    /**
     * Executed upon structure-generation. The entire game-room will be pushed to this function, so DO NOT run custom
     * loops here! Just either set a block, and return true, or skip it, and return false. IMPORTANT: Make sure to not
     * place anything directly on pBottomY when pOffsetY is 0, unless you want to replace the mossy-cobblestone bottom
     * of the struct
     *
     * @param pWorldObject The WorldObj for the Generator
     * @param pMaxXZ       The maximum X and Z offsets you will receive. If pOffsetZ == pMaxXZ, then you are on the the
     *                     corner of the struct
